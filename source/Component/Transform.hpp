...
namespace Component
{
	...
	struct Transform
	{
		...
		void draw_UI();
		static void serialise(std::ostream& p_out, uint16_t p_version, const Transform& p_transform);
		static Transform deserialise(std::istream& p_in, uint16_t p_version);
	};
}